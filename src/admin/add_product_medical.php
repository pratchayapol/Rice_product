...
<head>
    ...
    <title>เพิ่มข้อมูลผลิตภัณฑ์ทางการแพทย์</title>
...
<body class="bg t1">
    ...
    <div class="pt-24 flex items-center justify-center min-h-screen px-4">
        <div class="w-full max-w-3xl bg-white p-10 rounded-2xl shadow-xl">
            <h2 class="text-3xl font-semibold mb-8 text-center text-sky-600">เพิ่มข้อมูลผลิตภัณฑ์ทางการแพทย์</h2>
            ...
            <form method="POST" action="" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <select id="product_group" name="product_group" required
                        ...
                        <option value="เวชภัณฑ์จากสารออกฤทธิ์ในข้าว">เวชภัณฑ์จากสารออกฤทธิ์ในข้าว</option>
                        <option value="วัสดุทางการแพทย์จากข้าว">วัสดุทางการแพทย์จากข้าว</option>
                        <option value="ผลิตภัณฑ์ดูแลผิวสำหรับผู้ป่วย">ผลิตภัณฑ์ดูแลผิวสำหรับผู้ป่วย</option>
                        <option value="ผลิตภัณฑ์เฉพาะโรค">ผลิตภัณฑ์เฉพาะโรค</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <textarea id="ingredients_th" name="ingredients_and_equipment" rows="5"
                        class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-sky-400">รอเจ้าหน้าที่เพิ่มข้อมูล</textarea>
                </div>
