        ...
        <div class="w-full max-w-7xl px-4 md:px-8">
            <div class="text-center bg-white/70 py-24 px-10 rounded-2xl shadow-xl w-full mb-10">
                ...
                <div class="flex flex-col md:flex-row gap-6">
                    ...
                    <!-- Pie Chart -->
                    <div class="bg-white rounded-xl shadow overflow-visible" style="width: 400px; height: 400px; padding-top: 48px;">
                        <canvas id="productChart" style="width: 100%; height: 80%;"></canvas>
                    </div>
