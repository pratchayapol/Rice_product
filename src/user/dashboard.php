            ...
            <div class="text-center bg-white/70 py-24 px-10 rounded-2xl shadow-xl w-full mb-10">
                ...
                <div class="flex justify-center mb-8">
                    <div class="relative w-full max-w-md">
                        ...
                        <ul id="suggestions" class="absolute z-10 w-full bg-white border border-gray-300 rounded-b-lg mt-1 max-h-60 overflow-y-auto hidden text-left scrollbar-hide"></ul>
                    </div>
                </div>
